...
public class Constants {
    ...
    public static final String SCANNER_IDENTITY = "SCANNER_IDENTITY";

    public static final String MILK_BARCODE_ID = "442134341342";
    public static final String SUGAR_BARCODE_ID = "342134213332";
